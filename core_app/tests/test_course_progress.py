...
class TestCourseProgress(TestCase):
    ...
    def setUp(self):
        ...
        Unit.objects.create(UnitID=222222, UnitCode='abc111', Name='UCP', Version='100', Semester=2, Credits=25.0)
        Unit.objects.create(UnitID=111111, UnitCode='abc222', Name='CG', Version='100', Semester=1, Credits=25.0)
        Unit.objects.create(UnitID=333333, UnitCode='abc333', Name='SE', Version='100', Semester=2, Credits=25.0)
        Unit.objects.create(UnitID=444444, UnitCode='abc444', Name='PDM', Version='100', Semester=1, Credits=25.0)
        Unit.objects.create(UnitID=555, UnitCode='abc555', Name='HCI', Version='100', Semester=2, Credits=25.0)
        Unit.objects.create(UnitID=666, UnitCode='abc666', Name='Alogrithm', Version='100', Semester=1, Credits=25.0)
        Unit.objects.create(UnitID=777, UnitCode='abc777', Name='Metrics', Version='100', Semester=1, Credits=25.0)
        Unit.objects.create(UnitID=888, UnitCode='abc888', Name='OS', Version='100', Semester=2, Credits=25.0)
        Unit.objects.create(UnitID=999, UnitCode='abc999', Name='CC', Version='100', Semester=2, Credits=25.0)
        Unit.objects.create(UnitID=654321, UnitCode='abc321', Name='Cyber', Version='100', Semester=1, Credits=25.0)
