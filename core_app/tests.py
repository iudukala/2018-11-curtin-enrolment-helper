...
class TestCourseProgress(TestCase):
    ...
    def setUpTestData(cls):
        ...
        unit8 = Unit.objects.create(UnitID=741, UnitCode='abc741', Name='Metrics', Version='200', Semester=2, Credits=25.0)
        unit9 = Unit.objects.create(UnitID=741, UnitCode='abc741', Name='Metrics', Version='200', Semester=2, Credits=25.0)
        ...
        StudentUnit.objects.create(StudentID=student1, UnitID=unit7, Attempts=0, Status='1', PrerequisiteAchieved=True, Year=4, Semester=1)
        StudentUnit.objects.create(StudentID=student1, UnitID=unit7, Attempts=0, Status='1', PrerequisiteAchieved=True, Year=6, Semester=2)
