...
/***********************************************************************************************************/
var parsedJSON = {
  course: { name: 'Software Engineering (BEng)', id: '313605', version: '1'},
  template: [//Array of years
              [//Year 1
                [//Sem 1 Unit Objects
                  {id: 'MATH2012', name: 'E. Maths 120', credits: 25.0, status: 'PASS', attempts: 1, version: '1'},
                  {id: 'MCEN1000', name: 'E. Mech 100', credits: 25.0, status: 'PASS', attempts: 1, version: '1'},
                  {id: 'INDE1000', name: 'EF: P&C 100', credits: 25.0, status: 'PASS', attempts: 1, version: '1'},
                  {id: 'COMP1004', name: 'E. Prog 100', credits: 12.5, status: 'PASS', attempts: 1, version: '1'},
                  {id: 'ELECTIVE1', name: 'ELECTIVE', credits: 12.5, status: 'PASS', attempts: 1, version: '1'},
                ],
                [//Sem 2 Unit Objects
                  {id: 'MATH1003', name: 'E. Maths 140', credits: 25.0, status: 'PASS', attempts: 1, version: '1'},
                  {id: 'INDE1001', name: 'EF: D&P 100', credits: 25.0, status: 'PASS', attempts: 1, version: '1'},
                  {id: 'ELEN1000', name: 'E. Sys 100', credits: 25.0, status: 'PASS', attempts: 1, version: '1'},
                  {id: 'MAEN1000', name: 'E. Mat 100', credits: 25.0, status: 'PASS', attempts: 1, version: '1'},
                ]
              ],
              [//Year 2
                [//Sem 1 Unit Objects
                  {id: 'ISAD1000', name: 'SE 110', credits: 25.0, status: 'PASS', attempts: 1, version: '1'},
                  {id: 'COMP1001', name: 'OOPD 100', credits: 25.0, status: 'PASS', attempts: 1, version: '1'},
                  {id: 'STAT1002', name: 'SDA 101', credits: 12.5, status: 'PASS', attempts: 1, version: '1'},
                  {id: 'PRJM2000', name: 'PSP', credits: 12.5, status: 'PASS', attempts: 1, version: '1'},
                  {id: 'ELECTIVE2', name: 'ELECTIVE', credits: 25.0, status: 'PASS', attempts: 1, version: '1'}
                ],
                [//Sem 2 Unit Objects
                  {id: 'COMP1002', name: 'DSA', credits: 25.0, status: 'PASS', attempts: 1, version: '1'},
                  {id: 'COMP1000', name: 'UCP 120', credits: 25.0, status: 'PASS', attempts: 1, version: '1'},
                  {id: 'ISYS1001', name: 'DS 120', credits: 25.0, status: 'PASS', attempts: 1, version: '1'},
                  {id: 'CMPE2002', name: 'RE', credits: 25.0, status: 'PASS', attempts: 1, version: '1'}
                ]
              ],
              [//Year 3
                [//Sem 1 Unit Objects
