# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-05-27 05:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Year', fernet_fields.fields.EncryptedIntegerField(default=-1)),
                ('Semester', fernet_fields.fields.EncryptedIntegerField(default=-1, validators=[1, 2])),
        ...
        migrations.AlterUniqueTogether(
            name='course',
            unique_together=set([('CourseID', 'MidYearEntry')]),
        ),
        migrations.AlterUniqueTogether(
            name='studentunit',
